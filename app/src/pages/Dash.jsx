              ...
              {patents.map((patent) => (
                ...
                >
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      {patent.title}{" "}
                      <span className="patent-year" style={{ color: "#888" }}>
                        ({patent.year})
                      </span>
                    </div>
                    <div
                      className="patent-desc"
              ...
              >
                ...
                >
                  ...
                  <input
                    ...
                    value={newPatent.ppt || ""}
                    onChange={(e) =>
                      setNewPatent({ ...newPatent, ppt: e.target.value })
                    }
                    style={{
                      width: "100%",
                      padding: "10px",
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewPatent({ ...newPatent, psource: e.target.value })
                    }
                    style={{
                      width: "100%",
                      padding: "10px",
